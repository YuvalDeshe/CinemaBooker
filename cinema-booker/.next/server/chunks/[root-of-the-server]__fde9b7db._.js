module.exports = [
"[project]/CinemaBooker/cinema-booker/.next-internal/server/app/api/users/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CinemaBooker/cinema-booker/src/types/User.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/CinemaBooker/cinema-booker/src/lib/tokens.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/CinemaBooker/cinema-booker/src/lib/email.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/CinemaBooker/cinema-booker/node_modules/nodemailer/lib/nodemailer.js [app-route] (ecmascript)");
;
const transporter = __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
...
function generateVerificationEmailHtml(verificationUrl, userEmail) {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
function generateProfileUpdateEmailHtml(userName, updatedFields) {
...
function generateVerificationEmailText(verificationUrl, userEmail) {
    return `
...
function generateProfileUpdateEmailText(userName, updatedFields) {
    const fieldsText = updatedFields.map((field)=>{
        // Convert camelCase to readable format
        const readable = field.replace(/([A-Z])/g, ' $1').toLowerCase();
        return readable.charAt(0).toUpperCase() + readable.slice(1);
...
"[project]/CinemaBooker/cinema-booker/src/app/api/users/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$types$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/CinemaBooker/cinema-booker/src/types/User.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$lib$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/CinemaBooker/cinema-booker/src/lib/tokens.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/CinemaBooker/cinema-booker/src/lib/email.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request) {
    try {
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(newUser.password, SALT_ROUNDS);
        let hashedPaymentCard = [];
        if (Array.isArray(newUser.paymentCard) && newUser.paymentCard.length > 0) {
            hashedPaymentCard = await Promise.all(newUser.paymentCard.map(async (card)=>{
                const hashedNumber = await __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(card.cardNumber, SALT_ROUNDS);
        ...
        const { token: emailVerificationToken, expires: emailVerificationExpires } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$lib$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateEmailVerificationToken"])();
        ...
        const userToInsert = {
            ...
            userStatus: newUser.userStatus || __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$types$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].INACTIVE,
        ...
        try {
            const emailResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                to: newUser.email,
                subject: 'Verify Your Email - Cinema Booker',
                text: (0, __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateVerificationEmailText"])(verificationUrl, newUser.email),
                html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$CinemaBooker$2f$cinema$2d$booker$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateVerificationEmailHtml"])(verificationUrl, newUser.email)
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fde9b7db._.js.map